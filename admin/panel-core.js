...
// ═══════════════════════════════════════════════════════════════════════════════
(function() {
    let _realRecordFailed = null;
    // Nie pozwalamy nadpisać przez Object.defineProperty z writable:false
    const _origRecord = window.recordFailedAttempt;
    Object.defineProperty(window, 'recordFailedAttempt', {
        get: function() { return _realRecordFailed || _origRecord; },
        set: function(v) { 
            // Blokada – nie pozwalamy nadpisać z konsoli
            if (v !== _realRecordFailed && _realRecordFailed) return;
            _realRecordFailed = v;
        },
        configurable: false
    });
